...
WorkflowKoreaworkshop.initialise(params, log)
...
workflow KOREAWORKSHOP {
    ...
    // MODULE: MultiQC
    //
    //workflow_summary    = WorkflowKoreaworkshop.paramsSummaryMultiqc(workflow, summary_params)
    //ch_workflow_summary = Channel.value(workflow_summary)

    //methods_description    = WorkflowKoreaworkshop.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description, params)
